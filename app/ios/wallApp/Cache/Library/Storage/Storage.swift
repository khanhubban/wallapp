...
public final class CustomCacheStorage<Key: Hashable, Value> {
...
extension CustomCacheStorage: StorageAware {
...
public extension CustomCacheStorage {
  func transform<U>(transformer: Transformer<U>) -> CustomCacheStorage<Key, U> {
    return CustomCacheStorage<Key, U>(hybridStorage: hybridStorage.transform(transformer: transformer))
  }
}

extension CustomCacheStorage: StorageObservationRegistry {
  @discardableResult
  public func addStorageObserver<O: AnyObject>(
    _ observer: O,
    closure: @escaping (O, CustomCacheStorage, StorageChange<Key>) -> Void
  ) -> ObservationToken {
...
extension CustomCacheStorage: KeyObservationRegistry {
  @discardableResult
  public func addObserver<O: AnyObject>(
    _ observer: O,
    forKey key: Key,
    closure: @escaping (O, CustomCacheStorage, KeyChange<Value>) -> Void
  ) -> ObservationToken {
