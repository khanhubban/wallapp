...
import wallapp.pixel.bottomsheet3.BottomSheetState.Companion.Saver
...
fun BottomSheetScaffold(
    ...
    sheetExpandedOffset: Dp = BottomSheetScaffoldDefaults.SheetExpandedOffset,
    ...
    BoxWithConstraints(modifier) {
        ...
        val sheetExpandedOffsetPx = with(LocalDensity.current) { sheetExpandedOffset.toPx() }
        var bottomSheetHeight by remember { mutableStateOf(fullHeight) }

        val collapsedHeight = fullHeight - peekHeightPx
        val expandedHeight = fullHeight - bottomSheetHeight + sheetExpandedOffsetPx
        require(collapsedHeight != expandedHeight) {
            "collapsedHeight ($collapsedHeight) must differ from expandedHeight ($expandedHeight)"
        }
        ...
        val swipeable = Modifier
            ...
            .swipeable(
                ...
                anchors = mapOf(
                    collapsedHeight to BottomSheetValue.Collapsed,
                    expandedHeight to BottomSheetValue.Expanded,
                ),
